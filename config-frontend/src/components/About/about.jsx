...
const About = () => {
    ...
    return ( 
        <section className="about">
            <div>
                <svg class="arch-circle_desktop" width="2000" height="186" viewBox="0 0 2000 186" fill="#000000" xmlns="http://www.w3.org/2000/svg">
                    <title>Arch illustration - desktop </title>
                    <path fillRule="evenodd" clipRule="evenodd" d="M2000 157.654C1731.94 59.4275 1382.37 0 1000 0C617.634 0 268.057 59.4275 0 157.654V186H2000V157.654Z" fill="#ffffff"></path>
                </svg>
            </div>
            ...
            <div>
                <div className='about-content'>
                    <div>
                        <div>
                            <h2>A high-yield cash account that helps your savings grow.</h2>
                            <p>
